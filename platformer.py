...
pygame.display.set_caption("Jump Man Jump!")
...
class Player():
            ...
            for tile in world.tile_list:
                ...
                if tile[1].colliderect(self.rect.x, self.rect.y + dy, self.width, self.height):
                    ...
                    if self.vel_y < 0:
                        ...
                        self.vel_y = 0
                    #check if below the ground (falling)
                    elif self.vel_y >= 0:
            ...
            for platform in platform_group:
                ...
                if platform.rect.colliderect(self.rect.x, self.rect.y + dy, self.width, self.height):
                    ...
                    #check if above platforms
                        ...
                        self.in_air = False
                        dy = 0
                    #move sideways with the platforms
    ...
    def reset(self, x ,y):
        ...
        self.dead_image = pygame.image.load("img/reaper.png")
        self.image = self.images_right[self.index]
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
        ...
        for row in data:
            ...
            for tile in row:
                ...
                if tile == 2:
                    ...
                    self.tile_list.append(tile)
                if tile == 3:
                    virus = Enemy(col_count * tile_size, row_count * tile_size + 21)
    ...
    if main_menu == True:
        ...
        if game_over == 1:
            ...
            if level <= max_levels:
                ...
                draw_text("YOU WON!!!", font, blue, (screen_width // 2) - 140, screen_height)
                if restart_button.draw():
                    level = 1
                    #reset level
                    world_data = []
